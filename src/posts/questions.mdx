...
Engineering is more based around communication skills than I initially thought. Coding is just the final step in a
...
Almost every day, I find myself writing end-user documentation for a project that's already been created or a design
document for a project that needs to be done. In either case, effectively communicating your intentions and knowledge
is critical for the reader to understand why some piece of software exists and how it will/should be used.
